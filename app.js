...
<body>
    <div class="header">
        <div class="header-top">
            ...
            <div class="header-btns">
                ...
                <button class="header-btn" onclick="document.getElementById('csvInput').click()">📥 CSV</button>
                <button class="header-btn" onclick="exportCSV()">📤</button>
                <button id="themeToggle" class="header-btn" onclick="toggleTheme()" title="Toggle dark mode">🌙</button>
            </div>
        </div>
        <div class="quick-stats">
            ...
            <div class="mini-stat" id="quickVerdictBox">
                ...
                <div class="value green" id="quickVerdict">—</div>
    ...
    <div class="google-bar">
        ...
        <div class="google-btns">
            <button class="g-btn sync" id="syncBtn" onclick="syncData()" style="display:none">🔄 Sync</button>
    ...
    <div id="tabAdd" class="tab-content">
        <div class="card">
            <h3>Log a Journey</h3>
            <button class="journey-option bus" onclick="addJourney('bus')"><span class="opt-icon">🚌</span><div><div class="opt-label">Bus</div><div class="opt-sub">£1.75 · Hopper eligible</div></div></button>
            <button class="journey-option peak" onclick="addJourney('tube-peak')"><span class="opt-icon">🚇</span><div><div class="opt-label">Underground (Peak)</div><div class="opt-sub">£3.10 · Weekday 6:30–9:30, 16:00–19:00</div></div></button>
            <button class="journey-option offpeak" onclick="addJourney('tube-offpeak')"><span class="opt-icon">🚇</span><div><div class="opt-label">Underground (Off-Peak)</div><div class="opt-sub">£3.00 · All other times</div></div></button>
        </div>
    ...
    <nav class="tab-nav">
        <button class="tab-btn active" onclick="switchMobileTab('Dashboard', this)"><span class="icon">🏠</span><span>Home</span></button>
        <button class="tab-btn" onclick="switchMobileTab('Add', this)"><span class="icon">➕</span><span>Add</span></button>
        <button class="tab-btn" onclick="switchMobileTab('History', this)"><span class="icon">📋</span><span>History</span></button>
        <button class="tab-btn" onclick="switchMobileTab('Chart', this)"><span class="icon">📊</span><span>Chart</span></button>
        <button class="tab-btn" onclick="switchMobileTab('Analysis', this)"><span class="icon">🔍</span><span>Analysis</span></button>
    </nav>
    ...
    <script>
        ...
        function updateMobileQuickStats() {
            ...
            if (journeys.length > 0) {
                ...
                if (isPassWorthIt) { verdictEl.textContent = '✅ Worth it'; verdictEl.className = 'value green'; verdictSub.textContent = `Saving ${formatCurrency(Math.abs(stats.savings))}`; }
                else { verdictEl.textContent = '⚠️ Not yet'; verdictEl.className = 'value amber'; verdictSub.textContent = `PAYG saves ${formatCurrency(stats.savings)}`; }
            }
